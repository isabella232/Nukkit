...
public abstract class Entity extends Location implements Metadatable {
    ...
    public static final int DATA_FLAG_LEASHED = 30 - 1;
    public static final int DATA_FLAG_SHEARED = 31 - 1;
    public static final int DATA_FLAG_GLIDING = 32 - 1;
    public static final int DATA_FLAG_ELDER = 33 - 1;
    public static final int DATA_FLAG_MOVING = 34 - 1;
    public static final int DATA_FLAG_BREATHING = 35 - 1;
    public static final int DATA_FLAG_CHESTED = 36 - 1;
    public static final int DATA_FLAG_STACKABLE = 37 - 1;
    public static final int DATA_FLAG_SHOWBASE = 38 - 1;
    public static final int DATA_FLAG_REARING = 39 - 1;
    public static final int DATA_FLAG_VIBRATING = 40 - 1;
    public static final int DATA_FLAG_IDLING = 41 - 1;
    public static final int DATA_FLAG_EVOKER_SPELL = 42 - 1;
    public static final int DATA_FLAG_CHARGE_ATTACK = 43 - 1;
    public static final int DATA_FLAG_WASD_CONTROLLED = 44 - 1;
    public static final int DATA_FLAG_CAN_POWER_JUMP = 45 - 1;
    public static final int DATA_FLAG_LINGER = 46 - 1;
    public static final int DATA_FLAG_HAS_COLLISION = 47 - 1;
    public static final int DATA_FLAG_GRAVITY = 48 - 1;
    public static final int DATA_FLAG_FIRE_IMMUNE = 49 - 1;
    public static final int DATA_FLAG_DANCING = 50 - 1;
    public static final int DATA_FLAG_ENCHANTED = 51 - 1;
    public static final int DATA_FLAG_SHOW_TRIDENT_ROPE = 52 - 1; // tridents show an animated rope when enchanted with loyalty after they are thrown and return to their owner. To be combined with DATA_OWNER_EID
    public static final int DATA_FLAG_CONTAINER_PRIVATE = 53 - 1; //inventory is private, doesn't drop contents when killed if true
    //public static final int TransformationComponent 54 - 1; ???
    public static final int DATA_FLAG_SPIN_ATTACK = 55 - 1;
    public static final int DATA_FLAG_SWIMMING = 56 - 1;
